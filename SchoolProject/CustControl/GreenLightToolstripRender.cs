...
{
    class GreanLightToolstripRender : ToolStripProfessionalRenderer
    {
        ThemeSettings theme = new ThemeSettings(ThemeType.ToolStrip);
        System.Drawing.Font fnt = new System.Drawing.Font("Aril", 12F, System.Drawing.FontStyle.Bold);
        ...
        static GreanLightToolstripRender()
        {
            titleBarGripBmp = DeserializeFromBase64(titleBarGripEnc);

        }

        public GreanLightToolstripRender()
        {
            fnt = new Font(theme.FontName, theme.FontSize, theme.FontStyle);
