...
{
    class LightBlueRender:ToolStripProfessionalRenderer
    {
        System.Drawing.Font fnt = new System.Drawing.Font("Calibri", 11F, System.Drawing.FontStyle.Bold);
        ...
        private static Color StarColor = Color.FromArgb(150, Color.DeepSkyBlue);
        /*color.steelBlue*/// Color.FromArgb(150, Color.LightBlue), /*color.lighBlue*/     //Color.FromArgb(203, 255, 255);
        private static Color EndColor = Color.FromArgb(150, Color.LightBlue); 
        /*color.lighBlue*/     //Color.FromArgb(125, 165, 224);// Color.FromArgb(0, 100, 180);

        private static Color StarPressColor = Color.FromArgb(254, 128, 62);
        private static Color EndPressColor = Color.FromArgb(255, 223, 154);

        private static Color StarSelectColor = Color.FromArgb(255, 255, 222);
        private static Color EndSelectColor = Color.FromArgb(255, 203, 136);// Color.FromArgb(0, 0, 100);
        ...
        protected override void OnRenderDropDownButtonBackground(ToolStripItemRenderEventArgs e)
        {
            ...
            e.Graphics.DrawRectangle(
                System.Drawing.SystemPens.ControlDarkDark,
                bounds);
